...
export default function ProjectCard({title,description,image,link}:projectBase) {
  return (
    <Link href={link ? link : '#'}>
    <div className=" flex flex-col gap-4 border rounded-xl border-slate-800/70 bg-slate-950/70 shadow-lg shadow-fuchsia-500/10 backdrop-blur-2xl px-6 py-3 max-w-xl w-full mx-auto hover:-translate-y-1 hover:opacity-70 transition-all duration-700">
