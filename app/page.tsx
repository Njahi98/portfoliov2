...
export default function Home() {
  return (
    <main className="relative flex min-h-[calc(100vh-7rem)] flex-col items-center justify-center px-6 pt-10 pb-16 md:pt-0">
      ...
      <section className="mx-auto flex max-w-4xl flex-col items-center text-center">
        ...
        <div className="mb-10 flex flex-wrap items-center justify-center gap-3">
          <Link
            href="projects"
            className="inline-flex items-center gap-2 rounded-full border border-slate-700/80 bg-slate-950/60 px-5 py-2.5 text-sm font-medium text-slate-100 shadow-sm shadow-slate-950/60 transition hover:border-fuchsia-400/70 hover:text-fuchsia-100"
          >
            View Projects
